        ...
        <section class="container">
          ...
          <div>
            ...
            <section class="tac pt20">
              <a @click="toAllCourse" title="全部课程" class="comm-btn c-btn-2">全部课程</a>
            </section>
          </div>
        </section>
      </div>
      ...
      <div>
        <section class="container">
          ...
          <div>
            ...
            <section class="tac pt20">
              <a @click="toAllTeacher" title="全部讲师" class="comm-btn c-btn-2">全部讲师</a>
            </section>
          </div>
        </section>
      </div>
  ...
  methods: {
    ...
    initDataBanner() {
      banner.getBannerList().then(response => {
        this.bannerList = response.data.data.list; //注意这里是两个data
      });
    },
