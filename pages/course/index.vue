              ...
              <li v-for="item in data.items" :key="item.id">
                <div class="cc-l-wrap">
                  <section class="course-img">
                    <img :src="item.cover" height="150" width="267" class="img-responsive" :alt="item.title" />
                    <div class="cc-mask">
...
export default {
  ...
  methods: {
    ...
    searchOne(subjectParentId, index) {
      //通过index设置对应一级分类进行高亮显示，并设置二级分类不高亮
      this.oneIndex = index;
      this.twoIndex = -1;

      //将查询对象中的二级分类id清空、二级分类列表清空
