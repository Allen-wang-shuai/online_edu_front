                    ...
                    <div class="lh-menu-wrap">
                      <menu id="lh-menu" class="lh-menu mt10 mr10">
                        <ul>
                          <!-- 课程章节目录 -->
                          <li
                            v-for="(chapter,index1) in chapterList"
                            :key="chapter.id"
                            class="lh-menu-stair"
                          >
                            ...
                            <ol class="lh-menu-ol" style="display: block;">
                              <li
                                v-for="(video,index2) in chapter.children"
                                :key="video.id"
                                class="lh-menu-second ml30"
                              >
                                <a v-if="(index2 == 0 && index1 == 0) || isBuy" :href="'/player/'+video.videoSourceId" target="_blank">
                                  <span v-if="video.free === true || (index2 == 0 && index1 == 0)" class="fr">
